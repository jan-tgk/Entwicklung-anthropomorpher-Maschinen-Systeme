...
private const val TAG = "Orts Auskunft"

class OrtsAuskunft : RobotActivity(), RobotLifecycleCallbacks {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_orts_auskunft)
    ...
    override fun onRobotFocusGained(qiContext: QiContext) {
        ...
        val topic = TopicBuilder.with(qiContext).withResource(R.raw.orts_auskunft).build()
